export default function PrivacyPolicy() {
  return (
    <>
      <section className="bg-kron-green py-24 px-6">
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto prose prose-slate">
          <div className="space-y-8 text-kron-brown leading-relaxed">
            <div>
              <h2 className="text-xl font-bold text-kron-green mb-3">Introduction</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-kron-green mb-3">Information We Collect</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-kron-green mb-3">How We Use Your Information</h2>
            ...
            <div>
              <h2 className="text-xl font-bold text-kron-green mb-3">Data Security</h2>
              <p>
            ...
            <div>
              <h2 className="text-xl font-bold text-kron-green mb-3">Your Rights</h2>
              <p>
                ...
                <a href="mailto:Hello@kron.uk" className="text-kron-gold hover:underline">
                  Hello@kron.uk
                </a>.
              </p>
            </div>
            ...
            <div>
              <h2 className="text-xl font-bold text-kron-green mb-3">Contact</h2>
              <p>
